...
// iconSidenav
const iconSidenav = document.querySelectorAll(".iconSidenav");
...
if (iconSidenav) {
  for (const singleIconSideNav of iconSidenav) {
    singleIconSideNav.addEventListener("click", toggleSidenav);
  }
}
